...
public class MainActivity extends AppCompatActivity {
    ...
    public void abrirFlor (View h){
        Intent flore=new Intent (this,flor.class);
        startActivity (flore);
    }
    public void abrirSemente (View P){
        Intent semente = new Intent (this,semente.class);
        startActivity(semente);
    }
}